...
// 🪐 HAUMEA
const haumeaGeometry = new THREE.SphereGeometry(0.8, 64, 64);
...
// ✅ NO LIGHT MATERIAL
const haumeaMaterial = new THREE.MeshBasicMaterial({
    map: haumeaTexture
});

const haumea = new THREE.Mesh(haumeaGeometry, haumeaMaterial);

// 🪐 Real ellipsoid shape
haumea.scale.set(1.7, 0.7, 0.7);
